...
// Returns the private 'App\Repository\TovarRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TovarRepository.php';

return $this->privates['App\Repository\TovarRepository'] = new \App\Repository\TovarRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
