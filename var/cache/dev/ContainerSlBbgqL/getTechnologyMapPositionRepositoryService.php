...
// Returns the private 'App\Repository\TechnologyMapPositionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TechnologyMapPositionRepository.php';

return $this->privates['App\Repository\TechnologyMapPositionRepository'] = new \App\Repository\TechnologyMapPositionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
