...
// Returns the private 'App\Repository\TechnologyMapRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TechnologyMapRepository.php';

return $this->privates['App\Repository\TechnologyMapRepository'] = new \App\Repository\TechnologyMapRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
