 ...
 */
class TechnologyMap extends \App\Entity\TechnologyMap implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TechnologyMap' . "\0" . 'id', '' . "\0" . 'App\\Entity\\TechnologyMap' . "\0" . 'date_start', '' . "\0" . 'App\\Entity\\TechnologyMap' . "\0" . 'date_end', '' . "\0" . 'App\\Entity\\TechnologyMap' . "\0" . 'product'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TechnologyMap $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setDateStart(\DateTimeInterface $date_start): \App\Entity\TechnologyMap
    {
     ...
     * {@inheritDoc}
     */
    public function setDateEnd(?\DateTimeInterface $date_end): \App\Entity\TechnologyMap
    {
     ...
     * {@inheritDoc}
     */
    public function setProduct(?\App\Entity\product $product): \App\Entity\TechnologyMap
    {
